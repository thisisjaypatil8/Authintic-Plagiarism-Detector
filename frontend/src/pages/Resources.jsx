    ...
    const articles = [
        ...
        },
        {
            ...
            sections: [
                ...
                { type: 'text', content: 'A fine-tuned BERT model takes suspicious-source sentence pairs and classifies them as plagiarized or original. Trained on the PAN25 dataset with document-level splits and hard negative sampling, it achieves 99.35% accuracy. This layer is particularly effective against AI-assisted rewriting.' },
                { type: 'code', lines: [
                    'BERT input: [CLS] suspicious [SEP] source [SEP]',
                    'Output: binary classifier (original / plagiarized)',
                    '→ F1 Score: 0.99 on PAN25 test set',
                ]},
            ...
            <div className="container mx-auto px-6 max-w-5xl pb-16">
                ...
                <section id="faq" className="mb-16">
                    ...
                    <div className="space-y-3">
                        {[
                            { q: 'What file formats are supported?', a: 'Authintic supports .docx, and .txt files up to 10MB.' },
                            ...
                            { q: 'How accurate is the detection?', a: 'Authintic uses a 3-layer hybrid system (TF-IDF + FAISS + BERT) evaluated on the PAN25 benchmark. The BERT classifier achieves an F1 score of 0.99 with 99.35% accuracy on a balanced test set.' },
